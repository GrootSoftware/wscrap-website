						...
						<div class="col-md-9">
                            ...
                            <div class="environment-event environment-related-event">
                                ...
                                <ul class="row">
                                    <li class="col-md-4">
                                        <figure>
                                            <a href="event-detail.php"><img src="extra-images/event-related-img1.jpg" alt=""></a>
                                            <time datetime="2008-02-14 20:00">12<br>FEB</time>
                                        </figure>
                                        <div class="environment-related-event-text">
                                            <h5><a href="event-detail.php">Praesent mattis sapien nec lorem dictum eget</a></h5>
                                            <ul class="environment-large-option">
                                                <li>
                                                    Organizer:
                                                    <a href="event-detail.php">G. David</a>
                                                </li>
                                                <li>
                                                    Time:
                                    ...
                                    <li class="col-md-4">
                                        <figure>
                                            <a href="event-detail.php"><img src="extra-images/event-related-img2.jpg" alt=""></a>
                                    ...
                                    <li class="col-md-4">
                                        <figure>
                                            <a href="event-detail.php"><img src="extra-images/event-related-img3.jpg" alt=""></a>
